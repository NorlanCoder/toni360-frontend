          ...
          <section className="text-base md:text-lg">
            ...
            <div id="section-3" className="mb-8 text-lg md:text-xl">
              ...
              <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4 text-lg md:text-xl">
                <li>Utiliser l&apos;Application à des fins illicites ou non autorisées.</li>
                <li>Transmettre des informations fausses ou trompeuses lors de la création de son compte ou lors de toute commande.</li>
                <li>Tenter de perturber le fonctionnement de l&apos;Application ou d&apos;accéder à des données non autorisées.</li>
                <li>Reproduire, copier ou distribuer tout contenu de l&apos;Application sans autorisation préalable.</li>
              </ul>
            </div>
