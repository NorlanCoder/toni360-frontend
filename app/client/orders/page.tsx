  ...
  return (
    <div className="max-w-5xl">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
        <div className="flex items-center gap-3 bg-white border border-gray-200 rounded-xl px-5 py-4 transition hover:shadow-sm hover:border-[#008F4F] hover:bg-[#e8faf3]">
        ...
        <button className="flex items-center justify-center gap-2 bg-white border border-gray-200 rounded-xl px-4 py-3 text-[#008F4F] font-semibold hover:bg-[#e8faf3] transition">
          <Plus size={18} />
          Ajouter
        </button>
      </div>
      ...
      <div className="flex flex-wrap items-center gap-6 mb-10 text-base text-gray-600">
        <div className="flex items-center gap-2">
          <span>Du</span>
          <div className="flex items-center gap-2">
            <select className="w-14 px-3 py-1 pr-6 rounded-full border border-gray-200 text-center text-xs focus:outline-none focus:ring-2 focus:ring-toni-green-dark-2 bg-white">
              <option>JJ</option>
            ...
            <select className="w-20 px-3 py-1 pr-6 rounded-full border border-gray-200 text-center text-xs focus:outline-none focus:ring-2 focus:ring-toni-green-dark-2 bg-white">
              <option>AAAA</option>
      ...
      {/* Tabs */}
      <div className="flex items-center gap-16 mb-8 text-lg font-semibold text-gray-600">
        {[
